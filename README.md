...
- 32-bit xorshift pseudo-random generator  
- Turn system: play, swap, pass, automated AI play  
- Portuguese Scrabble rules and alphabet  
- TAD-based structured program design  

### Files in This Repository
- `scrabble2.py` - main game file  
- `vocab.txt` - Portuguese vocabulary list with 25k words
